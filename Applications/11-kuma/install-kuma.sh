...
#cd /tmp; rm install-kuma.sh &> /dev/null; wget https://raw.githubusercontent.com/b-tomasz/Simplify-Home-Automation/jdownloader/Applications/11-kuma/install-kuma.sh &> /dev/null; bash install-kuma.sh
