...
#cd /tmp; rm install-database.sh &> /dev/null; wget https://raw.githubusercontent.com/b-tomasz/Simplify-Home-Automation/main/Applications/12-influxdb/install-influxdb.sh &> /dev/null; bash install-influxdb.sh
